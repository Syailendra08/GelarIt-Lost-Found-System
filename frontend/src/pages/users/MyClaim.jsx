...
export default function MyClaim() {
    ...
    const renderActionButton = (
        ...
        if (
            ...
            return (
                <button
                    className="rounded-lg border border-yellow-300 bg-yellow-50 px-4 py-2 text-xs font-semibold text-yellow-700"
                >
                    Waiting Review
                </button>
            );
        ...
        if (
            ...
            return (
                <button
                    className="rounded-lg border border-blue-300 bg-blue-50 px-4 py-2 text-xs font-semibold text-blue-700"
                >
                    Under Review
                </button>
            );
        ...
        return (
            <button
                className="rounded-lg border border-red-300 bg-red-50 px-4 py-2 text-xs font-semibold text-red-600"
            >
                Request Rejected
            </button>
        );
