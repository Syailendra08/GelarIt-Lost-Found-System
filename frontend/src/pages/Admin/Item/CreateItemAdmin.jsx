...
import { ArrowLeft, Plus, CloudUpload } from "lucide-react";

import { createItem } from "../../../api/item.api";
import { getCategories } from "../../../api/categories.api";
import { getLocations } from "../../../api/locations.api";

export default function CreateItemAdmin() {
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            Swal.fire({
                icon: "success",
                title: result.message || "Create item success",
                timer: 1500,
            ...
            Swal.fire({
                icon: "error",
                title: error?.response?.data?.message || "Failed create item",
            });
        } finally {
            setLoading(false);
        }
            ...
            <div className="rounded-3xl border border-gray-200 bg-white p-8 shadow-sm">
                <div className="mb-8 flex items-center gap-3">
                    <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#EEF2FF]">
                        <Plus size={24} className="text-[#00288E]" />
                    </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                value={form.category}
                                onChange={handleChange}
                                className={`w-full rounded-2xl border px-4 py-3 text-sm outline-none transition ${errors.category
                                    ? "border-red-500"
                                    : "border-gray-300 focus:border-[#00288E]"
                                    }`}
                            >
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div>
                            ...
                            <select
                                ...
                                value={form.location}
                                onChange={handleChange}
                                className={`w-full rounded-2xl border px-4 py-3 text-sm outline-none transition ${errors.location
                                    ? "border-red-500"
                                    : "border-gray-300 focus:border-[#00288E]"
                                    }`}
                            >
                        ...
                        <div>
                            ...
                            <select
                                ...
                                value={form.status}
                                onChange={handleChange}
                                className={`w-full rounded-2xl border px-4 py-3 text-sm outline-none transition ${errors.status
                                    ? "border-red-500"
                                    : "border-gray-300 focus:border-[#00288E]"
                                    }`}
                            >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className={`w-full rounded-2xl border px-4 py-3 text-sm outline-none transition ${errors.color
                                ? "border-red-500"
                                : "border-gray-300 focus:border-[#00288E]"
                                }`}
                        />
                    ...
                    <div>
                        ...
                        <input
                            ...
                            value={form.date}
                            onChange={handleChange}
                            className={`w-full rounded-2xl border px-4 py-3 text-sm outline-none transition ${errors.date
                                    ? "border-red-500"
                                    : "border-gray-300 focus:border-[#00288E]"
                                }`}
                        />
